...
export default function VintageWhiteChromePage() {
  ...
  return (
    <div className="text-black" style={{ backgroundColor: 'var(--background)', minHeight: '100vh', color: 'var(--foreground)' }}>
      ...
      <div className="mb-8">
          <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-6xl font-bold text-black mb-5">Vintage - Белый хром</h2>
          ...
          <span className='mb-3'>.</span>
           ...
           <span className='mb-3'>.</span>
          <span className="text-white">Vintage - Белый хром</span>
        </nav>
        </div>
        </div>
