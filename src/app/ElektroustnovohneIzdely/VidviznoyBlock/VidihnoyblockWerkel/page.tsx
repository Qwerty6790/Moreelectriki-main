...
export default function S08GreyGraphitePage() {
  ...
  return (
    <div style={{ backgroundColor: 'var(--background)', minHeight: '100vh', color: 'var(--foreground)' }}>
      ...
      <div className="mb-8">
          <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-6xl font-bold text-black mb-5">Выдвижной блок Werkel</h2>
          ...
          <span className='mb-3'>.</span>
           <Link href="/ElektroustnovohneIzdely/VidviznoyBlock" className="hover:text-gray-200 transition-colors">Выдвижной блок</Link>
           <span className='mb-3'>.</span>
