    ...
    <div className="min-h-screen mt-20">
      ...
      <div className="w-full bg-white py-16">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-6xl font-black mb-8 text-left text-black ">
             MOREELEKTRIKI В ВАШЕМ ДОМЕ И ОФИСЕ
            </h2>
            <p className=' font-black mb-8 text-black tracking-tight'> Moreelektriki — это магазин стильных люстр и светильников для вашего дома и офиса. Мы собрали широкий ассортимент современного и классического освещения: от изящных хрустальных люстр и уютных бра до функциональных потолочных светильников и светодиодных решений.
